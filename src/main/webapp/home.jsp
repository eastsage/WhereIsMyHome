        ...
        <div class="row">
          <div class="input-group col-md-6">
            ...
            <div class="form-group mb-3">
              <select class="form-select bg-secondary text-light" id="sido" name = "sido" onchange="this.form.submit()" >
                <c:forEach var="sidoname" items="${sidos}" varStatus="loop">
                  <option value = "${sidoname}" <c:if test="${sidoname == sido}"> selected </c:if>>${sidoname}</option>
                </c:forEach>
              </select>
            </div>
            ...
            <div class="form-group mb-3">
              <select class="form-select bg-secondary text-light" id="gugun" name = "gugun" onchange="this.form.submit()">
                <c:forEach items="${guguns}" var="gugunname" varStatus="loop">
                  <option value = "${gugunname}" <c:if test="${gugunname== gugun}"> selected </c:if>>${gugunname}</option>
                </c:forEach>
              </select>
            </div>
            <div class="form-group mb-3">
              <select class="form-select bg-secondary text-light" id="dong" name = "dong" onchange="this.form.submit()">
                <c:forEach items="${dongs}" var="dongname" varStatus="loop">
                  <option value = "${dongname}" <c:if test="${dongname == dong}"> selected </c:if>>${dongname}</option>
                </c:forEach>
              </select>
            </div>
            <div class="form-group mb-3">
              <select class="form-select bg-dark text-light" id="year" name = "year" onchange="this.form.submit()">
              <option value="매매년도선택">매매년도선택</option>
            ...
            <div class="form-group mb-3">
              <select class="form-select bg-dark text-light" id="month" name = "month" onchange="this.form.submit()">
              <option value="매매월선택">매매월선택</option>
